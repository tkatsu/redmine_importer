...
The plugin has been tested on Redmine 1.1, 1.2.0, 2.2-stable, 2.3.2 (report by Jérôme BATAILLE) and320502(by T. Katsuyama)
...
- Prerequisites: Unless you are using ruby-1.9, you'll need the fastercsv gem (<code>gem install fastercsv</code> as root).
  ...
  Version 2.1.1 is tested by T.Katsuyama
