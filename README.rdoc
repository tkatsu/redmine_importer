...
The plugin has been tested on Redmine 1.1, 1.2.0, 2.2-stable, 2.3.2 (report by Jérôme BATAILLE) 
and 3.0.0 and Rails 4.2.0(by T. Katsuyama).
...
- Prerequisites: Unless you are using ruby-1.9, you'll need the fastercsv gem (<code>gem install fastercsv</code> as root).
  ...
  Ruby Version 2.1.2 is tested by T.Katsuyama 
  (Need gem 'roo' in Gemfile in $RAILS_ROOT. 'fastercsv' is NOT needed.)
